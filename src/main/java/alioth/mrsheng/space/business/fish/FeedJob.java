...
import alioth.mrsheng.space.core.utils.AESUtils;
...
public class FeedJob {
    ...
    public void doJob() {
        ...
        try {
            // 将加密后的food发送给8118端口
            // frps将监听此端口,然后将数据转发到树莓派上
            String url2 = "http://" + Environment.SERVER_IP + ":" + Environment.FRP_WEB_PORT + "/fish?food=" + AESUtils.encrypt(food);
