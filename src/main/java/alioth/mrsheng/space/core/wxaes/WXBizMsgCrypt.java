...
public class WXBizMsgCrypt {
    ...
    /**
     * token 验证方法
     * @param signature 签名串,对应 URL 参数的 signature(注意 post 携带 msg_signature 字段用来解密消息)
     * @param timeStamp 时间戳,对应 URL 参数的 timestamp
     * @param nonce 随机串,对应 URL 参数的 nonce
     * @return 签名是否合法
     * @throws AesException 执行失败,请查看该异常的错误码和具体的错误信息
     */
    public boolean verifyToken(String signature, String timeStamp, String nonce) throws AesException {
